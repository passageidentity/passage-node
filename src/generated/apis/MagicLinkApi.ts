...
export class MagicLinkApi extends runtime.BaseAPI {
     ...
     */
    async createMagicLinkRaw(
        requestParameters: CreateMagicLinkOperationRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<MagicLinkResponse>> {
        if (requestParameters.appId === null || requestParameters.appId === undefined) {
            throw new runtime.RequiredError(
                'appId',
                'Required parameter requestParameters.appId was null or undefined when calling createMagicLink.',
            );
        }

        if (
            requestParameters.createMagicLinkRequest === null ||
            requestParameters.createMagicLinkRequest === undefined
        ) {
            throw new runtime.RequiredError(
                'createMagicLinkRequest',
                'Required parameter requestParameters.createMagicLinkRequest was null or undefined when calling createMagicLink.',
            );
        }
        ...
        const response = await this.request(
            {
                path: `/apps/{app_id}/magic-links`.replace(
                    `{${'app_id'}}`,
