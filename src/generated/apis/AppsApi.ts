...
import type { AppResponse, Model401Error, Model404Error, Model500Error } from '../models';
import {
    AppResponseFromJSON,
    AppResponseToJSON,
...
export class AppsApi extends runtime.BaseAPI {
     ...
     */
    async getAppRaw(
        requestParameters: GetAppRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<AppResponse>> {
        if (requestParameters.appId === null || requestParameters.appId === undefined) {
            throw new runtime.RequiredError(
                'appId',
                'Required parameter requestParameters.appId was null or undefined when calling getApp.',
            );
        }
