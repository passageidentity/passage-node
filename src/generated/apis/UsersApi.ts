...
export class UsersApi extends runtime.BaseAPI {
     ...
     * Import Users
     */
    async importUsersRaw(requestParameters: ImportUsersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserCSVImportResponse>> {
        if (requestParameters.appId === null || requestParameters.appId === undefined) {
            throw new runtime.RequiredError('appId','Required parameter requestParameters.appId was null or undefined when calling importUsers.');
        }

        if (requestParameters.csvUserImport === null || requestParameters.csvUserImport === undefined) {
            throw new runtime.RequiredError('csvUserImport','Required parameter requestParameters.csvUserImport was null or undefined when calling importUsers.');
        }
        ...
        if (requestParameters.csvUserImport !== undefined) {
            formParams.append('csv_user_import', requestParameters.csvUserImport as any);
        }

        const response = await this.request({
            path: `/apps/{app_id}/import/users`.replace(`{${"app_id"}}`, encodeURIComponent(String(requestParameters.appId))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: formParams,
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => UserCSVImportResponseFromJSON(jsonValue));
    }
     ...
     * Import Users
     */
    async importUsers(requestParameters: ImportUsersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserCSVImportResponse> {
        const response = await this.importUsersRaw(requestParameters, initOverrides);
        return await response.value();
    }
