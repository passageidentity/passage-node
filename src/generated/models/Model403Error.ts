...
export const Model403ErrorCodeEnum = {
    CreateOrganizationBillingPortalSession: 'cannot_create_organization_billing_portal_session',
    DeleteAdmin: 'cannot_delete_admin',
    DeleteOrganizationMember: 'cannot_delete_organization_member',
    SelfUpdateOrganizationMember: 'cannot_self_update_organization_member'
} as const;
