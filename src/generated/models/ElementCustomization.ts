...
import { FontFamilyFromJSON, FontFamilyFromJSONTyped, FontFamilyToJSON } from './FontFamily';
...
export function ElementCustomizationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ElementCustomization {
    ...
    return {
        passageContainerBackgroundColor: !exists(json, 'passage_container_background_color')
            ? undefined
            : json['passage_container_background_color'],
        passageContainerMaxWidth: !exists(json, 'passage_container_max_width')
            ? undefined
            : json['passage_container_max_width'],
        passageInputBoxBackgroundColor: !exists(json, 'passage_input_box_background_color')
            ? undefined
            : json['passage_input_box_background_color'],
        passageInputBoxBorderRadius: !exists(json, 'passage_input_box_border_radius')
            ? undefined
            : json['passage_input_box_border_radius'],
        passageHeaderFontFamily: !exists(json, 'passage_header_font_family')
            ? undefined
            : FontFamilyFromJSON(json['passage_header_font_family']),
        passageBodyFontFamily: !exists(json, 'passage_body_font_family')
            ? undefined
            : FontFamilyFromJSON(json['passage_body_font_family']),
        passageHeaderTextColor: !exists(json, 'passage_header_text_color')
            ? undefined
            : json['passage_header_text_color'],
        passageBodyTextColor: !exists(json, 'passage_body_text_color') ? undefined : json['passage_body_text_color'],
        passagePrimaryButtonBackgroundColor: !exists(json, 'passage_primary_button_background_color')
            ? undefined
            : json['passage_primary_button_background_color'],
        passagePrimaryButtonTextColor: !exists(json, 'passage_primary_button_text_color')
            ? undefined
            : json['passage_primary_button_text_color'],
        passagePrimaryButtonHoverColor: !exists(json, 'passage_primary_button_hover_color')
            ? undefined
            : json['passage_primary_button_hover_color'],
        passagePrimaryButtonBorderRadius: !exists(json, 'passage_primary_button_border_radius')
            ? undefined
            : json['passage_primary_button_border_radius'],
        passageSecondaryButtonBackgroundColor: !exists(json, 'passage_secondary_button_background_color')
            ? undefined
            : json['passage_secondary_button_background_color'],
        passageSecondaryButtonTextColor: !exists(json, 'passage_secondary_button_text_color')
            ? undefined
            : json['passage_secondary_button_text_color'],
        passageSecondaryButtonHoverColor: !exists(json, 'passage_secondary_button_hover_color')
            ? undefined
            : json['passage_secondary_button_hover_color'],
        passageSecondaryButtonBorderRadius: !exists(json, 'passage_secondary_button_border_radius')
            ? undefined
            : json['passage_secondary_button_border_radius'],
    };
}
